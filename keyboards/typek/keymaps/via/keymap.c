...
[0] = LAYOUT( /* Base */
    ...
    KC_SCRL, LCTL_T(KC_ESC), KC_A   , KC_S   , KC_D   , KC_F   , KC_G   ,          KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT, KC_DEL ,
    MO(1)  , KC_LSFT       , KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,          KC_B   , KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,
             KC_LALT       , KC_LGUI,          KC_SPC , MO(2)  , KC_6   ,          KC_SPC , KC_SPC , KC_RALT, KC_BSLS, KC_ENT , MO(1)  , KC_RGUI
),
[1] = LAYOUT(
...
[2] = LAYOUT(
    ...
    KC_TRNS, TG(1)  , KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_LEFT, KC_DOWN, KC_UP  , KC_RIGHT, KC_TRNS, KC_TRNS, KC_TRNS,
    QK_BOOT, KC_TRNS, KC_VOLD, KC_VOLU, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS , UG_HUED, UG_HUEU, KC_TRNS,
